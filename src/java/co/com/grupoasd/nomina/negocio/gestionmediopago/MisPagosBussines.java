 ...
 * @author ASD
 */
public class MisPagosBussines implements IMisPagos {

    @Override
    public List<MisPagos> listar(int idEmp,int idPrueba, String cargoNombre) {
        GestionPagosDao gestiondao = new GestionPagosDao();
        List<MisPagos> MisPagos = gestiondao.listarpagos(idEmp,idPrueba,cargoNombre);
        return MisPagos;
    }
}
