...
public class EmpleadoDao {
    ...
    /**
     * Permite registrar un Empleado con los datos basicos y el municipio según
     * el dane
     *
     * @param empleado
     */
     ...
     * valor inicial es 0.5 millas. Por cada iteración aumenta 0.5 millas su
     * valor.
     * @param nivelCargo
     * @return
     */
                ...
                public void respuestaConsulta(final ResultSet res) {
                    try {
                        while (res.next()) {
                            ...
                            // que permite el cupo del sitio. Si el sitio no se llena en la primera iteración, lo hará en la segunda
                            // o tercera etc. 
                                ...
                                public void respuestaConsulta(ResultSet cercanos) {
                                    try {
                                        while (cercanos.next()) {
                                            ...
                                            // Update que asigna a una persona en un determinado sitio de la tabla asignación.
                                            // El update consta de una consulta interna que permite consultar un registro de la tabla
                                            // nombramiento. Como puede haber varios registros sin asignación de persona para un mismo
                        ...
                        // Aqui se controla la recursividad. Si se asignaron personas, continúa iterando.
