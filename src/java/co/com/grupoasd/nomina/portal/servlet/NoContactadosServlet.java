 ...
 */
@WebServlet(name = "NoContactadosServlet", urlPatterns = {"/NoContactadosServlet"})
public class NoContactadosServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       try {
            ...
            convocatoria.cargarNoContactado(nombreArchivoOrigen, pathArchivo, prueba, usuario);
                    
            String urlResult = request.getContextPath() + "/panel/CargaNoContactados/main.jsp";
