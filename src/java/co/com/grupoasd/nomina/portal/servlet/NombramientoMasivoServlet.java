 ...
 */
@WebServlet(name = "NombramientoMasivoServlet", urlPatterns = {"/NombramientoMasivoServlet"})
public class NombramientoMasivoServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       try {
            ...
            NombramientoMasivo nombramientoMasivo = new NombramientoMasivo();
            
            nombramientoMasivo.cargar(nombreArchivoOrigen, pathArchivo, prueba, usuario);
                    
            String urlResult = request.getContextPath() + "/panel/NombramientoMasivo/main.jsp";
