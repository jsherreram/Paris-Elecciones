...
import co.com.grupoasd.nomina.negocio.aceptacionConvocatoria.AceptacionConvocatoria;
import java.io.File;
 ...
 */
@WebServlet(name = "AceptacionConvocatoriaServlet", urlPatterns = {"/AceptacionConvocatoriaServlet"})
public class AceptacionConvocatoriaServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       try {
            ...
            AceptacionConvocatoria aceptacionConvocatoria = new AceptacionConvocatoria();
            
            aceptacionConvocatoria.cargarAceptacionConvocatoria(nombreArchivoOrigen, pathArchivo, prueba, usuario);
                    
            String urlResult = request.getContextPath() + "/panel/AceptacionConvocatoria/main.jsp";
