 ...
 * @author ASD
 */
@WebServlet(name = "CoberturaMedioPagosServlet", urlPatterns = {"/CoberturaMedioPagosServlet"})
public class CoberturaMedioPagosServlet  extends HttpServlet {
       ...
       try {
            ...
            for(FileItem item : partes)
            {
                if (item.isFormField()) {
                    ...
                    if(fieldname.equals("idmedio_pago"))
                    {
                        idmedio_pago = Integer.parseInt(item.getString());
                    }
                }else
                {
            ...
            CoberturaMedioPagoController coberturaMedioPagoController = new CoberturaMedioPagoController();
            coberturaMedioPagoController.cargarFileCobertura(nombreArchivoOrigen, pathArchivo, prueba, usuario, idmedio_pago);
                    
            String urlResult = request.getContextPath() + "/panel/ConfigurarMedioPago/main.jsp#/statusCargue/"+idmedio_pago+"/"+prueba;
