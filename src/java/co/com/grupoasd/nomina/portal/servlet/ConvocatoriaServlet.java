 ...
 */
@WebServlet(name = "ConvocatoriaServlet", urlPatterns = {"/ConvocatoriaServlet"})
public class ConvocatoriaServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       try {
            ...
            convocatoria.cargarConvocatoria(nombreArchivoOrigen, pathArchivo, prueba, usuario);
                    
            String urlResult = request.getContextPath() + "/panel/Convocatoria/main.jsp";
