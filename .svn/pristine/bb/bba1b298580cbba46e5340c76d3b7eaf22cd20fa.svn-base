...
import co.com.grupoasd.nomina.negocio.carguepagos.Pagos;
import java.io.File;
 ...
 */
@WebServlet(name = "PagosServlet", urlPatterns = {"/PagosServlet"})
public class PagosServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            pagos.cargarPagoViaticos(file.getName(), pathArchivo, Integer.parseInt(prueba.getString()), usuario);

            String urlResult = request.getContextPath() + "/panel/CargaPagos/main.jsp";
