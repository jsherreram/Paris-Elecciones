...
import co.com.grupoasd.nomina.salones.Salones;
import java.io.File;
 ...
 */
@WebServlet(name = "SalonesServlet", urlPatterns = {"/SalonesServlet"})
public class SalonesServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       try {
            ...
            salones.cargarSalones(nombreArchivoOrigen, pathArchivo, prueba, usuario);

            String urlResult = request.getContextPath() + "/panel/CargaSalones/main.jsp";
