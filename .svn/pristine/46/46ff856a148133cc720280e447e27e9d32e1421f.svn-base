    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="panel panel-primary">
              ...
              <div class="panel-body">
                <form class="form-horizontal" action="${pageContext.request.contextPath}/AplicacionServlet" method="post" enctype="multipart/form-data">
