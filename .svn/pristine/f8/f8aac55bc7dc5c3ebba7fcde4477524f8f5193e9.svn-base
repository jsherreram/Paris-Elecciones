...
<script type="text/javascript" src="${pageContext.request.contextPath}/panel/NombramientoMasivo/controller.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/panel/NombramientoMasivo/service.js"></script>
