...
<script type="text/javascript" src="${pageContext.request.contextPath}/panel/Convocatorias/controller.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/panel/Convocatorias/service.js"></script>
