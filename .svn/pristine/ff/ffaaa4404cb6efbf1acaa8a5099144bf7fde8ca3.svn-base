...
import co.com.grupoasd.nomina.capacitacion.Capacitacion;
import java.io.File;
 ...
 */
@WebServlet(name = "CapacitacionServlet", urlPatterns = {"/CapacitacionServlet"})
public class CapacitacionServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       try {
            ...
            capacitacion.cargarCapacitacion(nombreArchivoOrigen, pathArchivo, prueba, usuario);

            String urlResult = request.getContextPath() + "/panel/CargaCapacitacion/main.jsp";
