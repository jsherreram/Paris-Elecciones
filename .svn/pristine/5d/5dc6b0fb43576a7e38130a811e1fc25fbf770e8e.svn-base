...
<head>
    ...
    <!-- Page title -->
    <title>Elecciones | Ingreso de usuarios</title>
                ...
                <div class="panel-body">
                        <form action="${pageContext.request.contextPath}/login" method="post" id="loginForm">
                            <div class="form-group">
                                ...
                                <input type="text" title="Ingrese su nombre de usuario" required="" value="" name="username" id="username" class="form-control" maxlength="50">
                                <span class="help-block small">Ingrese su nombre de usuario</span>
                            </div>
                            <div class="form-group">
                                <label class="control-label" for="password">Contrase&ntilde;a</label>
                                <input type="password" title="Ingrese su contrase&ntilde;a" required="" value="" name="password" id="password" class="form-control" maxlength="50">
                                <span class="help-block small">Ingrese su contrase&ntilde;a</span>
                            </div>                           
                            <input type="submit" name="Ingresar" value="Ingresar" class="btn btn-info btn-block" />                
                            <p class="text-danger">Cambio realizado con &eacute;xito, favor revisar su e-mail</p>                       
                            <a href="${pageContext.request.contextPath}/redirigeRecupera" class="help-block small" align="center">Recuperar contraseña</a>
                        </form>
                </div>
            </div>
        </div>
