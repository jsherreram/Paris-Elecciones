        ...
        <div class="col-lg-12">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">  
                    <form name="reviewForm"  class="form-horizontal" ng-submit="buscar(idPrueba, idEvento)" method="post" enctype="multipart/form-data">

                        <div class="col-md-10">
                            <div class="form-group">
                                <label class="control-label col-md-2" for="prueba">Prueba:</label>
                                <div class="col-md-offset-2"> 
                                    <select ng-model="idPrueba" name="idPrueba" class="form-control" required="required" ng-change="listarEventos()">
                                        <option ng-repeat="prueba in pruebas" value="{{prueba.idprueba}}">{{prueba.nombre}}</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-2" for="evento">Sesión:</label>
                                <div class="col-md-offset-2">
                                    <select ng-model="idEvento" name="idEvento" class="form-control" required="required">
                                        <option ng-repeat="eve in eventos" value="{{eve.codigoEvento}}">{{eve.nombre}}</option>
                                    </select>
                                </div>
                            </div>

                            <div class="form-group">
                                <input class="btn btn-primary" style="float:right" type="submit" value ="Buscar">
                            </div>
                        </div>
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <div ng-show="total > 1 && soloConsultar" class="col-md-11" style="margin:2% 3% 1%;">
                        ...
                        <a href="templates/GenerarCSV.jsp?idPrueba={{idPrueba}}&usuario={{usuario}}&idEvento={{idEvento}}" style="float:right" class="btn btn-primary"><span class="glyphicon glyphicon-download-alt" aria-hidden="true"></span> CSV</a>
                    </div>
                    ...
                    <table class="table table-striped">
                        ...
                        <tr ng-repeat="sitio in sitios|orderBy:'codigoSitio' | filter:filtrar">
                            ...
                            <td ng-show="{{sitio.archivo === 'Si'}} && soloConsultar">
                                <a href="templates/verArchivo.jsp?idPrueba={{idPrueba}}&idSitio={{sitio.codigoPuesto}}&codEvento={{idEvento}}" class="btn btn-primary" style="margin-bottom: 1px">Ver &nbsp; Archivo</a> 
                            ...
                            <td ng-show="{{sitio.archivo === 'Si'}} && !soloConsultar">
                                <a href="templates/verArchivo.jsp?idPrueba={{idPrueba}}&idSitio={{sitio.codigoPuesto}}&codEvento={{idEvento}}" class="btn btn-primary">Ver &nbsp; Archivo</a> 
                            </td>
                        </tr>
                    </table>
                </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header" style="padding: 2%;">
                    ...
                    <h4 class="modal-title">Subir Archivo(s)</h4>
                </div>
                <div class="modal-body">


                    <form   action="${pageContext.request.contextPath}/UploadFileServletListadoAsistenciaSitio" method="post" enctype="multipart/form-data">
                        ...
                        <input type="text" name ="codEvento" ng-model ="idEvento"  style="display: none;" class="form-control" required="required" >
                        <input type="text" name ="multiple" value="no" style="display: none;" class="form-control" required="required" >

                        <div class="form-group">
                            <label class="control-label" for="file">Archivo(s) de Asistencia:</label>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form   action="${pageContext.request.contextPath}/UploadFileServletListadoAsistenciaSitio" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label class="control-label" for="file">Archivo de Asistencia:(Presione la tecla ctrl para seleccionar varios)</label>
                            <div>  
