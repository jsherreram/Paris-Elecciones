 ...
 */
@WebServlet(name = "SitioMasivoServlet", urlPatterns = {"/SitioMasivoServlet"})
public class SitioMasivoServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            SitioMasivo sitioMasivo = new SitioMasivo();

            sitioMasivo.cargar(nombreArchivoOrigen, pathArchivo, prueba, usuario);

            String urlResult = request.getContextPath() + "/panel/Sitios/main.jsp#/CargarSitios";
