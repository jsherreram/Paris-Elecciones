...
<%@include file="/panel/includes/javascripts.jsp" %>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/panel/ProgramarEventos/controller.js"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath}/panel/ProgramarEventos/service.js"></script>
