...
app.controller("appController", ['$scope', '$routeParams', '$location','SeguimientoFactory', function seguimientoController($scope, $routeParams, $location, SeguimientoFactory){
    ...
    $scope.getEventos = function(){
        SeguimientoFactory.getEventos(function (data) {
            $scope.evento = [];
            $scope.evento.push(data.evento[0]);
	});
    };
...
app.controller("appControllerUbicacion", ['$scope', '$routeParams', '$location','SeguimientoFactory','PersonaAsignada', function seguimientoController($scope, $routeParams, $location, SeguimientoFactory, PersonaAsignada){
        ...
        $scope.listar = function(){
            ...
            SeguimientoFactory.listarCapacitacion($routeParams.idEvento,$routeParams.idDepartamento,$routeParams.idMunicipio,$routeParams.idCargo,$routeParams.idZona,$routeParams.idPuesto, function (dataC) {
                $scope.capacitacion = dataC[0];
            });
