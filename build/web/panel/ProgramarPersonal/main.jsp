...
<script type="text/javascript" src="${pageContext.request.contextPath}/panel/ProgramarPersonal/controller.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/panel/ProgramarPersonal/service.js"></script>
