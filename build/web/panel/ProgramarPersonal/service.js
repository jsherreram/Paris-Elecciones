...
services.factory('SeguimientoFactory', function ($resource) {
    return {
        ...
        listarCapacitacion: function(idEvento, idDepartamento, idMunicipio, idCargo, idZona, idPuesto, callback) {
            return $resource(formulario.global.api+'/seguimiento/capacitacion?idEvento='+idEvento+'&idDepartamento='+idDepartamento+'&idMunicipio='+idMunicipio+'&idCargo='+idCargo+'&idZona='+idZona+'&idPuesto='+idPuesto, {}, {
                query: { 
                    method: 'GET', 
                    isArray:true
                }
