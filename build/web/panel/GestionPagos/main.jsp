...
<html ng-app='app'>
    ...
    <body>
        ...
        <script type="text/javascript" src="${pageContext.request.contextPath}/panel/GestionPagos/controller.js"></script>
        <script type="text/javascript" src="${pageContext.request.contextPath}/panel/GestionPagos/service.js"></script>
