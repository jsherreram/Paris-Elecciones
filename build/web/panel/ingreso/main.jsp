...
<script type="text/javascript" src="${pageContext.request.contextPath}/panel/terceros/controller.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/panel/terceros/service.js"></script>
