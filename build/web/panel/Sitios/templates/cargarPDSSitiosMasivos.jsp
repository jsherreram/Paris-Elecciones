<div class="content animate-panel">
        ...
        <div class="col-md-10">
            <div class="panel panel-default">
                <div class="panel-heading">                  
                    <h2>Cargue Archivo PDS-Sitio </h2>
                </div>
                    ...
                    <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <div class="col-md-10 col-md-offset-1">  
                                <a class="btn btn-primary" data-toggle="modal" data-target="#myModalpds">Cargar Archivo</a>
                                <a href="templates/verArchivo.jsp?name=demoPdsSitio" class="btn btn-primary">Descargar Ejemplo.csv</a>
                            </div>
                        </div>
                    </form>
                </div>
    ...
    <div class="modal fade" id="myModalpds" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form   action="${pageContext.request.contextPath}/PdsSitioMasivoServlet" method="post" enctype="multipart/form-data">
                        <input type="text"  style="display: none;" name="prueba" ng-model="controller.idPrueba">

                        <div class="form-group">
                            <label class="control-label" for="file">Examinar:</label>
                            <div>  
                                <input type="file" name ="file" ng-model ="file" accept=".csv" class="form-control" required="required">
                            </div>
                        </div>
                        <div class="form-group">
