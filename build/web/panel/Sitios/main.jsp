...
<html ng-app='app'>
    ...
    <body>
        ...
        <script type="text/javascript" src="${pageContext.request.contextPath}/panel/Sitios/js/config.js"></script>
        <script type="text/javascript" src="${pageContext.request.contextPath}/panel/Sitios/js/routes.js"></script>
        <script type="text/javascript" src="${pageContext.request.contextPath}/panel/Sitios/js/controllers/consultarSitio.js"></script>
        <script type="text/javascript" src="${pageContext.request.contextPath}/panel/Sitios/js/controllers/registrarSitio.js"></script>
        <script type="text/javascript" src="${pageContext.request.contextPath}/panel/Sitios/js/controllers/cargarArchivoSitios.js"></script>
        <script type="text/javascript" src="${pageContext.request.contextPath}/panel/Sitios/js/controllers/geolocalizarSitios.js"></script>
        <script type="text/javascript" src="${pageContext.request.contextPath}/panel/Sitios/js/services/PruebaSitio.js"></script>
        ...
        <script src="${pageContext.request.contextPath}/js/services/UsuarioDepartamento.js" type="text/javascript" ></script>
        ...
        <script type="text/javascript" src="${pageContext.request.contextPath}/panel/Sitios/js/services/Maps.js"></script>        
    </body>
</html>