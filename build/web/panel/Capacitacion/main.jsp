...
<script type="text/javascript" src="${pageContext.request.contextPath}/panel/Capacitacion/controller.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/panel/Capacitacion/service.js"></script>
