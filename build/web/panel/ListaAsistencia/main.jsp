...
<script type="text/javascript" src="${pageContext.request.contextPath}/panel/ListaAsistencia/controller.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/panel/ListaAsistencia/service.js"></script>
