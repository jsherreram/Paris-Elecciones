...
<script type="text/javascript" src="${pageContext.request.contextPath}/panel/departamentos/controller.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/panel/departamentos/service.js"></script>
