...
<%
        ...
        if(!user.equals("")) {
            ...
            String codEvento=request.getParameter("idEvento");
            String filename = "LISTADO_ASISTENCIA_SITIOS_"+idPrueba+"_"+codEvento+".csv";
                       
            g.GeneraListadoAsistenciaSitioEvento(usuario, idPrueba, codEvento);
