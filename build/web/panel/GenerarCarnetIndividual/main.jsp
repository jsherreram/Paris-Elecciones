...
<script type="text/javascript" src="${pageContext.request.contextPath}/panel/GenerarCarnetIndividual/js/config.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/panel/GenerarCarnetIndividual/js/routes.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/panel/GenerarCarnetIndividual/js/controllers/generarCarnetIndividual.js"></script>
