...
<html ng-app='app'>
    ...
    <body>
        ...
        <script type="text/javascript" src="${pageContext.request.contextPath}/panel/ReporteCuentaDeCobro/js/config.js"></script>
        <script type="text/javascript" src="${pageContext.request.contextPath}/panel/ReporteCuentaDeCobro/js/routes.js"></script>
        <script type="text/javascript" src="${pageContext.request.contextPath}/panel/ReporteCuentaDeCobro/js/controllers/generarCuentaDeCobro.js"></script>
