...
<script type="text/javascript" src="${pageContext.request.contextPath}/panel/CancelarCierre/controller.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/panel/CancelarCierre/service.js"></script>
