...
<html ng-app='app'>
    ...
    <body>
       ...
       <!-- <script type="text/javascript" src="${pageContext.request.contextPath}/assets/js/ui-bootstrap-tpls-1.3.2.min.js"></script>-->
        ...
        <script type="text/javascript" src="${pageContext.request.contextPath}/panel/GestionPersonas_1/js/config.js"></script>
        <script type="text/javascript" src="${pageContext.request.contextPath}/panel/GestionPersonas_1/js/routes.js"></script>
        <script type="text/javascript" src="${pageContext.request.contextPath}/panel/GestionPersonas_1/js/controllers/gestionarPersona.js"></script>
        <script type="text/javascript" src="${pageContext.request.contextPath}/panel/GestionPersonas_1/js/controllers/RegistrarPersona.js"></script>
        <script type="text/javascript" src="${pageContext.request.contextPath}/panel/GestionPersonas_1/js/controllers/EditarPersonaDetallado.js"></script>
        <script type="text/javascript" src="${pageContext.request.contextPath}/panel/GestionPersonas_1/js/controllers/VerHistorialArchivos.js"></script>
        <script type="text/javascript" src="${pageContext.request.contextPath}/panel/GestionPersonas_1/js/controllers/cargarArchivoPersonas.js"></script>
        <script type="text/javascript" src="${pageContext.request.contextPath}/panel/GestionPersonas_1/js/controllers/verPersonaDetallado.js"></script>
        <script type="text/javascript" src="${pageContext.request.contextPath}/panel/GestionPersonas_1/js/controllers/verHistorialLaboral.js"></script>
        <script type="text/javascript" src="${pageContext.request.contextPath}/panel/GestionPersonas_1/js/controllers/geolocalizar.js"></script>
        <script type="text/javascript" src="${pageContext.request.contextPath}/panel/GestionPersonas_1/js/controllers/subirAhorroalaMano.js"></script>
        <script type="text/javascript" src="${pageContext.request.contextPath}/panel/GestionPersonas_1/js/services/GestionPersonas.js"></script>
        <script type="text/javascript" src="${pageContext.request.contextPath}/panel/GestionPersonas_1/js/services/CargaArchivo.js"></script>
