...
<script type="text/javascript" src="${pageContext.request.contextPath}/panel/CargaSalones/controller.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/panel/CargaSalones/service.js"></script>
