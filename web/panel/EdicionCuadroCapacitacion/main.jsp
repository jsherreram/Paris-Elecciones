...
<html ng-app='app'>
    ...
    <body>
        ...
        <!--<script type="text/javascript" src="${pageContext.request.contextPath}/assets/js/angularjs-dropdown-multiselect.js"></script>-->
       ...
       <!-- <script type="text/javascript" src="${pageContext.request.contextPath}/assets/js/ui-bootstrap-tpls-1.3.2.min.js"></script>-->
        ...
        <script type="text/javascript" src="${pageContext.request.contextPath}/panel/EdicionCuadroCapacitacion/js/config.js"></script>
        <script type="text/javascript" src="${pageContext.request.contextPath}/panel/EdicionCuadroCapacitacion/js/routes.js"></script>
        <script type="text/javascript" src="${pageContext.request.contextPath}/panel/EdicionCuadroCapacitacion/js/controllers/aplicacion.js"></script>
        <script type="text/javascript" src="${pageContext.request.contextPath}/panel/EdicionCuadroCapacitacion/js/services/aplicacionServ.js"></script>
