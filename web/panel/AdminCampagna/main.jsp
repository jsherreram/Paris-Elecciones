...
<!--        <style>#map {height: 350px;} form .content {padding: 0} .map {width: 100% !important; height: 100% !important; padding: 0 !important}</style>-->
    ...
    <body>
        ...
        <script type="text/javascript" src="${pageContext.request.contextPath}/panel/AdminCampagna/js/config.js"></script>
        <script type="text/javascript" src="${pageContext.request.contextPath}/panel/AdminCampagna/js/routes.js"></script>
        <script type="text/javascript" src="${pageContext.request.contextPath}/js/services/Campagna.js"></script>
        <script type="text/javascript" src="${pageContext.request.contextPath}/panel/AdminCampagna/js/controllers/adminCampagna.js"></script>
