...
<script type="text/javascript" src="${pageContext.request.contextPath}/panel/carne/controller.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/panel/carne/service.js"></script>
