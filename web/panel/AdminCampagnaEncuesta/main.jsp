...
<html ng-app='app'>
    ...
    <body>
        ...
        <script type="text/javascript" src="${pageContext.request.contextPath}/panel/AdminCampagnaEncuesta/js/config.js"></script>
        <script type="text/javascript" src="${pageContext.request.contextPath}/panel/AdminCampagnaEncuesta/js/routes.js"></script>
        <script type="text/javascript" src="${pageContext.request.contextPath}/js/services/Campagna.js"></script>
        ...
        <script type="text/javascript" src="${pageContext.request.contextPath}/panel/AdminCampagnaEncuesta/js/controllers/adminCampagnaEncuesta.js"></script>
