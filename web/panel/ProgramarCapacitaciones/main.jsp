...
<html ng-app='app'>
    ...
    <body>
        ...
        <script type="text/javascript" src="${pageContext.request.contextPath}/panel/ProgramarCapacitaciones/controller.js"></script>
        <script type="text/javascript" src="${pageContext.request.contextPath}/panel/ProgramarCapacitaciones/service.js"></script>
        ...
        <!-- Steps -->
        <!-- Color picker -->
        <script src="${pageContext.request.contextPath}/plantillas/js/plugins/colorpicker/bootstrap-colorpicker.min.js"></script>
