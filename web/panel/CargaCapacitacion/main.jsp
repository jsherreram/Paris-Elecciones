...
<script type="text/javascript" src="${pageContext.request.contextPath}/panel/CargaCapacitacion/controller.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/panel/CargaCapacitacion/service.js"></script>
