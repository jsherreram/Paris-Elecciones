        ...
        <div class="col-md-10">
            <div class="panel panel-default">
                <div class="panel-heading">                  
                    <h2>Cargue Archivo de Sitios</h2>
                </div>
                    ...
                    <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <div class="col-md-10 col-md-offset-1">  
                                <a class="btn btn-primary" data-toggle="modal" data-target="#myModal">Cargar Archivo</a>
                                <a href="templates/verArchivo.jsp?name=demoSitios" class="btn btn-primary">Descargar Ejemplo.csv</a>
                            </div>
                        </div>
                    </form>
                </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form   action="${pageContext.request.contextPath}/SitioMasivoServlet" method="post" enctype="multipart/form-data">
