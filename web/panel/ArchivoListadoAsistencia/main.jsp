...
<script type="text/javascript" src="${pageContext.request.contextPath}/panel/ArchivoListadoAsistencia/controller.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/panel/ArchivoListadoAsistencia/service.js"></script>
