...
<script type="text/javascript" src="${pageContext.request.contextPath}/panel/ReportarAsistencia/controller.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/panel/ReportarAsistencia/service.js"></script>
