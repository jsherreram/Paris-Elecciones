...
<script type="text/javascript" src="${pageContext.request.contextPath}/panel/NombramientoViaticos/controller.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/panel/NombramientoViaticos/service.js"></script>
