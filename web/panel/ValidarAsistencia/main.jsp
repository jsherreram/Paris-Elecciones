...
<html ng-app='app'>
    ...
    <body>
       ...
       <!-- <script type="text/javascript" src="${pageContext.request.contextPath}/assets/js/ui-bootstrap-tpls-1.3.2.min.js"></script>-->
        ...
        <script type="text/javascript" src="${pageContext.request.contextPath}/panel/ValidarAsistencia/js/config.js"></script>
        <script type="text/javascript" src="${pageContext.request.contextPath}/panel/ValidarAsistencia/js/routes.js"></script>
        <script type="text/javascript" src="${pageContext.request.contextPath}/panel/ValidarAsistencia/js/controllers/validarAsistenciaController.js"></script>
        <script type="text/javascript" src="${pageContext.request.contextPath}/panel/ValidarAsistencia/js/controllers/listarSitiosAsistenciaController.js"></script>
        <script type="text/javascript" src="${pageContext.request.contextPath}/panel/ValidarAsistencia/js/services/ValidacionAsistencia.js"></script>
