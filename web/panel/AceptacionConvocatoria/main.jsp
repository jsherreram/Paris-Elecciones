...
<script type="text/javascript" src="${pageContext.request.contextPath}/panel/AceptacionConvocatoria/controller.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/panel/AceptacionConvocatoria/service.js"></script>
