        ...
        <div class="col-lg-12">
            <div class="panel panel-primary">
              ...
              <div class="panel-body">
                ...
                <form class="form-horizontal" action="${pageContext.request.contextPath}/ConvocatoriaServlet" method="post" enctype="multipart/form-data">
