                ...
                <div class="panel-body">
                        <form action="${pageContext.request.contextPath}/login" method="post" id="loginForm">
                            <div class="form-group">
                                ...
                                <input type="text" title="Ingrese su nombre de usuario" required="" value="" name="username" id="username" class="form-control">
                                <span class="help-block small">Ingrese su nombre de usuario</span>
                            </div>
                            <div class="form-group">
                                <label class="control-label" for="password">Contrase&ntilde;a</label>
                                <input type="password" title="Ingrese su contrase&ntilde;a" required="" value="" name="password" id="password" class="form-control">
                                <span class="help-block small">Ingrese su contrase&ntilde;a</span>
                            </div>    
                            <p class="text-danger">Usuario o contrase&ntilde;a inv&aacute;lidos</p>                       
